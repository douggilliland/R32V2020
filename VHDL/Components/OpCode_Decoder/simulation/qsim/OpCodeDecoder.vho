...
ENTITY 	OpCodeDecoder IS
	...
	Op_HCF : BUFFER std_logic;
	Op_NOP : BUFFER std_logic;
	Op_RES : BUFFER std_logic;
	Op_ADS : BUFFER std_logic;
	Op_MUL : BUFFER std_logic;
	Op_MAO : BUFFER std_logic;
	Op_ORS : BUFFER std_logic;
	Op_ARS : BUFFER std_logic;
	Op_XRS : BUFFER std_logic;
	Op_LS1 : BUFFER std_logic;
	Op_RS1 : BUFFER std_logic;
	Op_LR1 : BUFFER std_logic;
	Op_RR1 : BUFFER std_logic;
	Op_RA1 : BUFFER std_logic;
	Op_ENS : BUFFER std_logic;
	Op_LIL : BUFFER std_logic;
	Op_LIU : BUFFER std_logic;
	Op_LDB : BUFFER std_logic;
	Op_SDB : BUFFER std_logic;
	Op_LDS : BUFFER std_logic;
	Op_SDS : BUFFER std_logic;
	Op_LDL : BUFFER std_logic;
	Op_SDL : BUFFER std_logic;
	Op_LPB : BUFFER std_logic;
	Op_SPB : BUFFER std_logic;
	Op_LPS : BUFFER std_logic;
	Op_SPS : BUFFER std_logic;
	Op_LPL : BUFFER std_logic;
	Op_SPL : BUFFER std_logic;
	Op_JSR : BUFFER std_logic;
	Op_RTS : BUFFER std_logic;
	Op_BRA : BUFFER std_logic;
	Op_BCS : BUFFER std_logic;
	Op_BCC : BUFFER std_logic;
	Op_BOV : BUFFER std_logic;
	Op_BEQ : BUFFER std_logic
	);
END OpCodeDecoder;
