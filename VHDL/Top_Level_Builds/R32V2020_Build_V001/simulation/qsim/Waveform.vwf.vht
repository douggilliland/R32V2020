...
-- *****************************************************************************
-- Generated on "05/21/2019 20:49:21"
                                                             
-- Vhdl Test Bench(with test vectors) for design  :          OpCodeDecoder
-- 
...
ENTITY OpCodeDecoder_vhd_vec_tst IS
END OpCodeDecoder_vhd_vec_tst;
ARCHITECTURE OpCodeDecoder_arch OF OpCodeDecoder_vhd_vec_tst IS
-- constants                                                 
-- signals                                                   
