...
waitForRxData:
  ...
  ars r12,r10,r12    ; AND the receive data present bit with the status register bit that was read (r10 AND r12 => R12)
...
waitForTxReady:
  lpb r12            ; read the status register from the peripheral bus
  ars r12,r11,r12    ; AND the transmit data buffer empty bit with the status register but that was read
